...
<html lang="en">
	<head>
	    ...
	    <title>Резултат от търсенето</title>
...
<div class="side-menu animate-dropdown outer-bottom-xs">
    <div class="head"><i class="icon fa fa-align-justify fa-fw"></i>Под категории</div>        
...
{?>							
	...
	<div class="product">		
			...
			<div class="product-price">	
				...
				<div class="action">
					...
					<?php if($row['productAvailability']=='Да'){?>
							...
							<button class="btn btn-primary" type="button">Добави в кошницата</button></a>
								<?php } else {?>
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>Няма намерени продукти</h3>
		</div>

...
<head>
	...
	<title>Админ| Редактиране на подкатегория</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Редактиране на подкатегория</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Име на подкатегория</label>
<div class="controls">
<input type="text" placeholder="Въведи името на категорията"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>

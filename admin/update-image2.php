...
$_SESSION['msg']="Снимката на продукта е сменена успешно";
...
<head>
	...
	<title>Админ| Поднови снимката на продукта</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Поднови снимка 2 на продукта</h3>
							</div>
...
{?>
									...
									<strong>Супер</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>

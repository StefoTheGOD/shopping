...
<html lang="en">
	<head>
	    ...
	    <title>Моят списък с желания</title>
...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th colspan="4">Моите любими продукти</th>
				</tr>
			</thead>
			<tbody>
<?php
...
?>
						...
						<div class="rating">
							...
							<span class="review">( <?php echo htmlentities($num);?> Ревюта )</span>
						</div>
						<?php } ?>
						<div class="price">
							<?php echo htmlentities($row['pprice']);?>.00 Лв.
							
						</div>
					</td>
					<td class="col-md-2">
						<a href="my-wishlist.php?page=product&action=add&id=<?php echo $row['pid']; ?>" class="btn-upper btn btn-primary">Добави в количката</a>
					</td>
					<td class="col-md-2 close-btn">
						<a href="my-wishlist.php?del=<?php echo htmlentities($row['wid']);?>" onClick="return confirm('Сигурен ли си, че искаш да изтриеш?')" class=""><i class="fa fa-times"></i></a>
					</td>
				</tr>
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">Вашият списък с любими продукти е празен</td>

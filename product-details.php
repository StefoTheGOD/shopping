	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			...
			$_SESSION['cart'][$row_p['id']]=array("quantity" => 1, "price" => $row_p['productPrice']);
					echo "<script>alert('Продуктът е добавен в количката')</script>";
		echo "<script type='text/javascript'> document.location ='my-cart.php'; </script>";
		}else{
			$message="ID на продукта не е правилно";
		}
	}
}
$pid=intval($_GET['pid']);
...
<html lang="en">
	<head>
	    ...
	    <title>Детайли на продукта</title>
...
?>		
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">(<?php echo htmlentities($num);?> Ревюта)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price"><?php echo htmlentities($row['productPrice']);?> Лв. </span>
									...
									<div class="col-sm-6">
										<div class="favorite-button m-t-10">
											<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Списък с желания" href="product-details.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='Да'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> Добави в количката</a>
													<?php } else {?>
							<div class="action" style="color:red">Няма наличност</div>
					<?php } ?>
									</div>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								...
								<li><a data-toggle="tab" href="#review">РЕВЮ</a></li>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">Ревюта на клиенти</h4>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Качество :</b>  <?php echo htmlentities($rvw['quality']);?> Звезда</div>
													<div class="text"><b>Цена :</b>  <?php echo htmlentities($rvw['price']);?> Звезда</div>
													<div class="text"><b>Стойност :</b>  <?php echo htmlentities($rvw['value']);?> Звезда</div>
										...
										<div class="product-add-review">
											<h4 class="title">Напиши свое ревю</h4>
												...
												<div class="table-responsive">
													<table class="table table-bordered">	
														...
														<tbody>
															...
															<tr>
																<td class="cell-label">Стойностт</td>
														...
														<div class="row">
															<div class="col-sm-6">
																<div class="form-group">
																	<label for="exampleInputName">Име<span class="astk">*</span></label>
																<input type="text" class="form-control txt" id="exampleInputName" placeholder="" name="name" required="required">
																</div><!-- /.form-group -->
																<div class="form-group">
																	<label for="exampleInputSummary">Резюме <span class="astk">*</span></label>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">Ревю <span class="astk">*</span></label>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper">Предай Ревюто</button>
														</div><!-- /.action -->
...
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">Подобни продукти</h3>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					<?php echo htmlentities($rw['productPrice']);?>	Лв.		</span>
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Добави в количката</a>

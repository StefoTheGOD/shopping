		...
		<table class="table table-bordered">
			<thead>
				...
				<th class="cart-romove item">#</th>
					...
					<th class="cart-total item">Общо</th>
					<th class="cart-total item">Начин на плащане</th>
					<th class="cart-description item">Дата на поръчка</th>
					<th class="cart-total last-item">Проследи</th>
				</tr>
			</thead><!-- /thead -->
...
?>
				<tr>
					...
					<td><a href="pending-orders.php?id=<?php echo $row['oid']; ?> ">Изтрии</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"><a href="payment-method.php">Продължи към плащането</a></button>
...
<?php } else {?>
<tr>
<td colspan="10" align="center"><h4>Няма намерени резултати</h4></td>
</tr>
<?php } ?>
